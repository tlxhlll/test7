...
public class IJKPlayerActivity extends Activity implements View.OnClickListener {
    ...
    private void init() {
        ...
        showVolume=findViewById(R.id.set_volume);
        ...
        showVolume.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            @Override
            ...
            @Override
            public void onStopTrackingTouch(SeekBar seekBar) {
                showVolume.setVisibility(View.INVISIBLE);
            }
        });
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.btn_recycle:
                if(btnRecycle.getText().toString().equals(getResources().getString(R.string.recycle))){
                    btnRecycle.setText("单次");
                    isRecycle=true;
                }
                else{
                    btnRecycle.setText(getResources().getString(R.string.recycle));
                    isRecycle=false;
                }
                break;
            case R.id.btn_volume:
                ...
                showVolume.setMax(maxVolume);
                int currentVolume=am.getStreamVolume(AudioManager.STREAM_MUSIC);
                showVolume.setProgress(currentVolume);
                showVolume.setVisibility(View.VISIBLE);
        }
    }
